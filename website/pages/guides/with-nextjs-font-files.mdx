...
description:
  A guide for bringing custom font files to your Chakra xui project running on
  Next.js
...
[this github issue](https://github.com/chakra-xui/chakra-xui/issues/1791). It does
...
```jsx
import { ChakraProvider, Global, extendTheme } from "@chakra-xui/react"
...
Now you're ready to use the default Chakra xui components with your custom fonts.
