---
title: Using Chakra xui's official create-react-app templates
description:
  A guide for creating create-react-app projects from the official Chakra xui
  templates
...
We provide two official `create-react-app` templates for Chakra xui: one for
...
The template name for the JavaScript project is `@chakra-xui`. The template name
for the TypeScript project is `@chakra-xui/typescript`.

```bash
# JavaScript using npm
npx create-react-app my-app --template @chakra-xui
# JavaScript using yarn
yarn create react-app my-app --template @chakra-xui

# TypeScript using npm
npx create-react-app my-app --template @chakra-xui/typescript
# TypeScript using yarn
yarn create react-app my-app --template @chakra-xui/typescript
```

## What's included

The official templates are similar to the base `create-react-app` template, but
they come with Chakra xui dependencies pre-installed and include Chakra-specific
functionality.
...
- Animated Chakra xui logo instead of the React logo
