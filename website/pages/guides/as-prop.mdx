...
## Option 1: Using `forwardRef` from `@chakra-xui/react`

This is the recommended approach as it ensures your components forwards their
reference properly.

> Note 🚨: You need to use forwardRef from chakra-xui not react.

```tsx live=false
import { forwardRef, Box, BoxProps } from "@chakra-xui/react"
...
```tsx live=false
import { ChakraComponent, Box, BoxProps } from "@chakra-xui/react"
