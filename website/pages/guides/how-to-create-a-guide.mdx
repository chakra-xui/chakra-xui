...
description: A guide for creating a Chakra xui guide
tags: ["meta"]
author: with-heart
---

**Creating a new guide for Chakra xui takes four steps:**
...
You can also open the `.mdx` file for this guide or any other Chakra xui guide
for inspiration.

## Open a pull request

Once you've created your guide, the final step is to open a pull request to the
Chakra xui repository. You'll need to fork the Chakra repo, push your changes to
