import { Box, Heading, SimpleGrid, Stack, Text } from "@chakra-xui/react"
  ...
  return (
    <PageContainer
      ...
      frontmatter={{
        ...
        description:
          "A rich compilation of technical descriptions and detailed information of how Chakra xui works.",
      }}
    >
      <Text mt="2">
        A rich compilation of technical descriptions and detailed information of
        how Chakra xui works.
      </Text>
