...
```js
import { Input } from "@chakra-xui/react"
```
...
component. Chakra xui exports `InputGroup`, `InputLeftAddon`, and
...
component. Chakra xui exports `InputLeftElement` and `InputRightElement` to help
with this use case.
