...
<ComponentLinks
  github={{ package: "icon" }}
  npm={{ package: "@chakra-xui/icon" }}
/>

<carbon-ad></carbon-ad>

## Using Chakra xui icons

<<<<<<< HEAD
Chakra provides a set of commonly used interfact icons you can use in your
project. To these icons, install `@chakra-xui/icons`, import the icon you need
=======
Chakra provides a set of commonly used interface icons you can use in your
project. To use these icons, install `@chakra-xui/icons`, import the icons you need
>>>>>>> c773820ed23e0e114ca160d8bf6eeb3684f2ea23
and style them.

### Installation

```bash
npm i @chakra-xui/icons
# or
yarn add @chakra-xui/icons
```

### Usage

```jsx live=false
import { PhoneIcon, AddIcon, WarningIcon } from '@chakra-xui/icons'
...
1. Import the `Icon` component from `@chakra-xui/react`
...
They can be imported from `@chakra-xui/react`:

```jsx live=false
import { Icon, createIcon } from "@chakra-xui/react"
```
...
```jsx live=false
import { createIcon } from "@chakra-xui/icons"
