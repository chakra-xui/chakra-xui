---
title: "Comparison"
description: "What makes Chakra xui different from other UI libraries"
---
...
Here's a comparison between Chakra xui and other popular UI or CSS frameworks
...
**Chakra xui**: A library of carefully created React components that comes with
...
**Chakra xui**: Comes with a very intuitive, CSS-like, and prop based model of
...
**Chakra xui**: Authoring responsive styles in a very easy and intuitive way. You
...
**Chakra xui**: Given that Chakra xui styles are prop-based, overrides is as easy
as passing a prop.
...
**Chakra xui**: All components are light and dark mode compatible. You can also
author your own light and dark mode experience across your application.

## How is Chakra different from Theme UI?

- Chakra xui was heavily inspired by Theme UI and follows the system UI
  specifications.
- Chakra xui provide more components, improved styling API, accessibility, and
...
Since Chakra xui uses CSS-in-JS under the hood (`emotion` + `styled system`),
...
Chakra xui is a perfect fit.

## The Community 💖

My favourite thing about Chakra xui is the community around it. Despite the fact
that it is still small for now, it is growing daily and everyone is so helpful
and we keep striving for better ways to improve Chakra xui's speed, performance
...
**— Vynlar**
[(View Quote)](https://github.com/chakra-xui/chakra-xui/issues/1421#issuecomment-664423035)
...
**— ChasinHues**
[(View Quote)](https://github.com/chakra-xui/chakra-xui/issues/1421#issuecomment-692369895)
