...
version: 1.1+
description:
  Chakra xui provides built-in support right-to-left (RTL) languages like arabic
...
Chakra xui makes it possible to support RTL languages and LTR languages in the
...
Since Chakra xui is built on top of `@emotion/react`, you can leverage stylis
...
This is the recommended way to support RTL in Chakra xui. With this approach we
...
- Blog Post -
  [Setup an i18n routing with Nextjs and Chakra xui](https://dev.to/ugbechike/setup-an-internationalization-i18n-routing-web-app-with-nextjs-and-chakra-xui-39f1)
- MDN
  [CSS Logical Properties](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties)
