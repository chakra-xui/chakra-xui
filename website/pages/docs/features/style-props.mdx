...
title: Style Props
description:
  Learn how to use style props in Chakra xui. Style props are a way to alter the
...
```jsx live=false
import { Text } from "@chakra-xui/react"
...
```jsx live=false
import { Box, Flex } from "@chakra-xui/react"
...
```jsx live=false
import { Box, Grid } from "@chakra-xui/react"
...
```jsx
<Button as="a" target="_blank" variant="outline" href="https://chakra-xui.com">
  Hello
</Button>
```
