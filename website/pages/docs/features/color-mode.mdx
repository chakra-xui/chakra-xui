---
title: "Color Mode"
package: "@chakra-xui/color-mode"
description: Working with color mode (light and dark mode) in Chakra xui
---
...
import { extendTheme, ChakraProvider } from "@chakra-xui/react"
...
export const onRenderBody = ({ setPreBodyComponents }) => {
  setPreBodyComponents([
    <ColorModeScript initialColorMode="light" key="chakra-xui-no-flash" />,
  ])
}
```
