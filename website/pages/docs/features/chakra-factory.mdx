...
[list of elements](https://github.com/chakra-xui/chakra-xui/blob/develop/packages/system/src/system.utils.ts#L9)
supported.
...
Another example that combines the default `shouldForwardProp` from Chakra xui
with custom logic.

```jsx live=false
import { shouldForwardProp } from "@chakra-xui/react"
