---
title: Contributing to Chakra xui
description:
...
We want contributing to Chakra xui to be enjoyable and educational for anyone and
...
- Fork the Chakra xui repository on Github
- Clone your fork to your local machine
  `git clone git@github.com:<yourname>/chakra-xui.git`
...
```sh
git remote add upstream git@github.com:chakra-xui/chakra-xui.git
git checkout master
...
Chakra xui uses Gatsby for its documentation website. Thank you in advance and
