...
import { Box, Flex, Grid, useTheme } from "@chakra-xui/react"
import {
  ColorPalette,
  ColorPalettes,
  ColorWrapper,
...
[default theme](https://github.com/chakra-xui/chakra-xui/tree/master/packages/theme)
