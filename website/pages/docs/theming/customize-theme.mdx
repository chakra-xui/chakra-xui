...
description: How to modify Chakra xui's default theme
---
...
> the
> [default theme foundation style files](https://github.com/chakra-xui/chakra-xui/tree/master/packages/theme/src/foundations).
...
> reference the
> [default component style files](https://github.com/chakra-xui/chakra-xui/tree/master/packages/theme/src/components).
