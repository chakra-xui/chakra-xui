---
title: Center
package: "@chakra-xui/layout"
image: "components/center.svg"
description:
  Box is the most abstract component on top of which all other Chakra xui
...
```js
import { Center, Square, Circle } from "@chakra-xui/react"
```
